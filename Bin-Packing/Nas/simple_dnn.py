...
class GraphCoverModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        example_preds = preds[0:4]  # shape [20]
        # example_pred_labels = pred_labels[0]  # shape [20]
        example_labels = labels[0:4]  # shape [20]
        ...
        self.print("Expected (label[0]):      ", example_labels.float().tolist())
        self.print("Predicted (preds[0]):     ", list(map(float,example_preds.squeeze(dim=1).tolist())))
