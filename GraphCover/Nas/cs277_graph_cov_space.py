...
from nni.nas.hub.pytorch.modules import NasBench201Cell
...
class NasBench201(ModelSpace):
    ...
    def __init__(self,
        ...
        last_dim = num_labels // 4
        self.global_pooling = nn.AdaptiveAvgPool2d((last_dim, last_dim))
        self.classifier = nn.Linear(C_prev * last_dim ** 2, self.num_labels)
